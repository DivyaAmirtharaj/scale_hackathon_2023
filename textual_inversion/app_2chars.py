...
stub = Stub(name="comic-charactergen-01")
...
volume = NetworkFileSystem.persisted("comic-charactergen01-vol")
MODEL_DIR = Path("/model")
# NEXT_MODEL_DIR = Path("/next_model")
